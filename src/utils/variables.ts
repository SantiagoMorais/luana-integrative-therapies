export const instagramLink: string =
   "https://www.instagram.com/dra.luanaalvarenga/";
...
const defaultWhatsappMessage: string =
   "Olá, dra.Luana, eu encontrei o seu contato pelo seu site. Eu gostaria de agendar uma consulta.";
const phoneNumber: number = 5531991571662;
export const whatsappLink: string = `https://api.whatsapp.com/send?phone=${phoneNumber}&text=${formatMessageForWeb(
