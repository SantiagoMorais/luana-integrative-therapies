        ...
        <Container>
            ...
            <section className="commingSoonContent">
                <div className="info">
                    ...
                    <p className="advise">
                        Estamos trabalhando duro para trazer novidades incríveis para você!
                    </p>
                    <p className="advise">
                        Esta parte do nosso site está em desenvolvimento e em breve estará disponível para proporcionar uma experiência ainda melhor. Estamos ansiosos para compartilhar tudo com você!
                        Enquanto isso, explore as outras seções do nosso site e fique atento para mais atualizações.
                    </p>
                    <p className="advise">
