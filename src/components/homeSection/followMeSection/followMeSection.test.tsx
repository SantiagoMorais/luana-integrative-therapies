...
describe("<FollowMeSection />", () => {
    it("should render the component correctly", () => {
        ...
        const title = screen.getByText(/Gostaria de conhecer um pouco mais sobre o mundo das terapias integrativas?/i);
    ...
    it("should have the correct HTML structure", () => {
        render(<FollowMeSection />);
        const content = screen.getByText(/Gostaria de conhecer um pouco mais sobre o mundo das terapias integrativas?/i).closest('.content');
