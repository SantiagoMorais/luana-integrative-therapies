      ...
      <Container>
         <div className="content">
            ...
            <div className="info instagram">
               <h3 className="title">
                  Gostaria de conhecer um pouco mais sobre o mundo das terapias
                  integrativas?
               </h3>
               <p className="message">
            ...
            <div className="info">
               ...
               <p className="message">
                  Precisa de orientações ou quer agendar uma consulta? Entre em
                  contato clicando no botão abaixo e faça sua reserva agora
                  mesmo.
               </p>
               <button className="button">
